...
abd:	goToXY(x, y + 6); cout << "                                                                                     ";
	goToXY(x, y + 6); cout << "Enter date number : "; cin >> ngay1; ngayk = convertStringToInt(ngay1, ngay); cout << endl;
...
adap:	goToXY(x, y + 7); cout << "                                                                           ";
	goToXY(x, y + 7); cout << "Absent or Present ?(Present(1) /Absent(0)): "; cin >> ap1; apk = convertStringToInt(ap1, ap); cout << endl;
...
ab3:goToXY(x, y + 9); cout << "Choose those option to continue ";
	...
	goToXY(x, y + 13); cout << "Your choice: "; cin >> opt1; optk = convertStringToInt(opt1, opt);
	if (optk == false) {
