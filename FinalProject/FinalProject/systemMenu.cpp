...
void staffCourseMenu(Semester*& pSemester)
{
	int choice;
	while (true)
	{
		system("cls");
		int x = 10, y = 5;
		goToXY(x, y++); cout << "1. Import courses from a csv file." << endl;
		goToXY(x, y++); cout << "2. Manually add a new course" << endl;
		goToXY(x, y++); cout << "3. Edit an existing course" << endl;
		goToXY(x, y++); cout << "4. Remove a course" << endl;
		goToXY(x, y++); cout << "5. Remove a specific student from a course" << endl;
		goToXY(x, y++); cout << "6. Add a specific student to a course" << endl;
		goToXY(x, y++); cout << "7. View list of courses in the current semester" << endl;
		goToXY(x, y++); cout << "8. View list of students of a course" << endl;
		goToXY(x, y++); cout << "9. View attendance list of a course" << endl;
